...
class UserConfig {
	...
	</ label="Background colour as R,G,B", help="( 0-255 values allowed )\nSets the colour of background elements.\nLeave blank if you want the colour from the randomized to be stored permanently.", option="0", order=7 /> bgrgb="255,255,0"//bgrgb="17,72,117"
	</ label="Accent colour as R,G,B", help="( 0-255 values allowed )\nSets the colour of accent elements.\nLeave blank if you want the colour from the randomized to be stored permanently.", option="0", order=8 /> selrgb="254,58,124" //selrgb="220,98,21"
	</ label="Title colour as R,G,B", help="( 0-255 values allowed )\nSets the colour of accent elements.\nLeave blank if you want the colour from the randomized to be stored permanently.", option="0", order=8 /> titrgb="254,58,124" //selrgb="220,98,21"
	</ label="Game Selection Bar Colour as R,G,B", help="( 0-255 values allowed )\nSets the colour of accent elements.\nLeave blank if you want the colour from the randomized to be stored permanently.", option="0", order=9 /> gslrgb="255,255,0" 
	...
	</ label="--------    Extra Art 1 Animation Otions     --------", help="Show or hide additional images", order=27 /> uct7="Select Below   "
	</ label="Enable Big Art", help="Enable Big Art", options="Yes,No", order=28 /> enable_bigart="No"; 
	...
	</ label="Enable Big Art Fade on Selection", help="Enable Big Art Fade on Selection", options="Yes,No", order=31 /> enable_bigartfade="No";
	</ label="Enable Big Art Fade on Load", help="Enable Big Art Fade on Load", options="Yes,No", order=32 /> enable_bigartfadeonload="No"; 
	</ label="Enable Big Art Scale on Selection", help="Enable Big Art Scale on Selection", options="Yes,No", order=33 /> enable_bigartscale="Yes"; 
	</ label="Enable Big Art Scale on Load", help="Enable Big Art Scale on Load", options="Yes,No", order=34 /> enable_bigartscaleonload="Yes"; 
	</ label="Enable Big Art Rotate on Selection", help="Enable Big Art Rotate on Selection", options="Yes,No", order=35 /> enable_bigartrotate="No";
	</ label="Enable Big Art Rotate on Load", help="Enable Big Art Rotate on Load", options="Yes,No", order=36 /> enable_bigartrotateonload="No";	 
	</ label="Enable Big Art Fly-in on Selection", help="Enable Big Art Fly-in on Selection", options="Yes,No", order=37 /> enable_bigartflyin="No";
</ label="--------    Extra Art 2 Animation Otions     --------", help="Show or hide additional images", order=38 /> uct8="Select Below";
	</ label="Select Big Art Foldert", help="Select Big Art Folder", options="wheel, marquee, flyer, fanart, boxart, cartart", order=40 /> select_bigartfolder2="fanart";
	</ label="Enable Big Art Fade on Selection", help="Enable Big Wheel Art Fade on Selection", options="Yes,No", order=42 /> enable_bigartfade2="No";
	</ label="Enable Big Art Fade on Load", help="Enable Big Art Fade on Load", options="Yes,No", order=43 /> enable_bigartfadeonload2="No"; 
	</ label="Enable Big Art Scale on Selection", help="Enable Big Art Scale on Selection", options="Yes,No", order=44 /> enable_bigartscale2="Yes"; 
	</ label="Enable Big Art Scale on Load", help="Enable Big Art Scale on Load", options="Yes,No", order=45 /> enable_bigartscaleonload2="Yes"; 
	</ label="Enable Big Art Rotate on Selection", help="Enable Big Art Rotate on Selection", options="Yes,No", order=46 /> enable_bigartrotate2="No";
	</ label="Enable Big Art Rotate on Load", help="Enable Big Art Rotate on Load", options="Yes,No", order=47 /> enable_bigartrotateonload2="No";	 
	</ label="Enable Big Art Fly-in on Selection", help="Enable Big Art Fly-in on Selection", options="Yes,No", order=48 /> enable_bigartflyin2="No";
 }
...
local gtext = fe.add_text("[Overview]", flx*0.73, fly*0.251, flw*0.25, flh*0.45 );
gtext.set_rgb( 0, 0, 0 );
...
//gameListBox.set_rgb(  240, 240, 240 );
...
local bigart = fe.add_artwork(( my_config["select_bigartfolder"] ), flx*0, fly*0.46, flw*0.25, flh*0.3);
...
//System Image
//////////
local systemimage = fe.add_image(( "systems/[DisplayName]"), flx*0.6, fly*0.837, flw*0.38, flh*0.15);
systemimage.alpha=255;
systemimage.set_rgb(titRGB[0],titRGB[1],titRGB[2])
systemimage.preserve_aspect_ratio = true;

local sysstemimagescale_onload = {
    when = When.StartLayout,
    when = Transition.ToNewList,
    property = "scale",
    start = 1.2,
...
local sysstemimagergb_onload = {
    when = When.StartLayout,
    when = Transition.ToNewList,
    property = "color",
    start = { red = 17, green = 169, blue = 234 }//17,169,234
    end = { red = 254, green = 58, blue = 124 }
    time = 5000	
	loop = true,
    tween = Tween.Quad,
}

animation.add( PropertyAnimation ( systemimage, sysstemimagescale_onload ) );
//animation.add( PropertyAnimation ( systemimage, sysstemimagergb_onload ) );
